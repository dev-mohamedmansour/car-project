                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-sm-12">
                                <div class="title-home text-center py-1">
                                    <div class="inner">
                                        <h4 class="p-0 m-0">Welcome to your dashboard – Your gateway to productivity and success !! </h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
							<div class="col-sm-12 col-md-12 col-lg-4 mb-30">
								<div class="card card-box customer-card">
                                    <img class="card-img-top" src="../images/users-img.jpg" alt="Card image cap" />
									<div class="card-body text-center">
										<h5 class="card-title weight-500">Customer Datatable</h5>
										<p class="card-text">
							...
							<div class="col-sm-12 col-md-12 col-lg-4 mb-30">
								<div class="card card-box customer-card">
                                    <img class="card-img-top" src="../images/Schedule & Events.jpg" alt="Card image cap" />
									<div class="card-body text-center">
										<h5 class="card-title weight-500">Schedule & Events</h5>
										<p class="card-text">
											Stay organized and keep track of your meetings, appointments, and deadlines with ease.
										</p>
										<a href="users.html" class="btn btn-primary btn-block">
