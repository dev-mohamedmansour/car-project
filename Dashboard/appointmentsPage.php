            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="card-box mb-30 pb-5">
                        <div class="pd-20">
                            <h4 class="text-purple h4">Customer Appointments Overview</h4>
                        </div>
                        <div class="pb-20">
                            <table class="table hover multiple-select-row data-table-export nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="table-plus">Mohamed Ali</td>
                                        <td>01012345678</td>
                                        <td>Toyota - Corolla</td>
                                        <td>March 25, 2024 - 10:30 AM</td>
                                        <td>Oil change required</td>
                                        <td>
                                            <div class="dropdown">
                                                <a class="btn btn-link font-24 p-0 line-height-1 no-arrow" href="#"
                                    ...
                                    <tr>
                                        <td class="table-plus">Ahmed Hassan</td>
                                        <td>01234567890</td>
                                        <td>Hyundai - Elantra</td>
                                        <td>March 26, 2024 - 2:00 PM</td>
                                        <td>Brake check and tire replacement</td>
                                        <td>
                                            <div class="dropdown">
                                                <a class="btn btn-link font-24 p-0 line-height-1 no-arrow" href="#"
                                                    role="button" data-toggle="dropdown">
                                    ...
                                    <tr>
                                        <td class="table-plus">Sara Mahmoud</td>
                                        <td>01122334455</td>
                                        <td>Kia - Sportage</td>
                                        <td>March 27, 2024 - 11:00 AM</td>
