								  ...
								  <?php
									  include "Logic/userLogic/AuthLogic.php";
										 ...
										 if (isset($_SESSION['error']) && !empty($_SESSION['error'])) {
												echo '<div id="error-message" class="error-message">' . htmlspecialchars($_SESSION['error']) . '</div>';
					   ...
					   <div id="wrap2" class="wrap" style="display: none;">
							<div class="login-wrap p-4 p-md-5">
								  <div id="signup-form">
									    ...
									    <form method="post" onsubmit="return formValidate2();" novalidate>
											 <div id="error2"></div>
											 <div data-mdb-input-init class="form-outline mb-4">
												   <input class="form-control" type="text" name="username" id="Username2" required>
												   <label class="form-label" for="username2">User name</label>
											 </div>
											 <div data-mdb-input-init class="form-outline mb-4">
												   <input type="email" class="form-control" name="register-email" id="Email2" required>
											 ...
											 <div data-mdb-input-init class="form-outline mb-4">
												   <input type="password" class="form-control" name="register-password" id="Password2" required/>
												   <label class="form-label" for="Password2">Password</label>
											 </div>
											 <div class="form-group">
												   <button type="submit" name="sign-up" class="submit form-control btn px-3">Sign Up</button>
											 </div>
											 <p class="text-center">Already a member? <a onclick="showLogin()" class="sign-link">SignIn</a></p>
									    </form>
								  </div>
							</div>
					   </div>
