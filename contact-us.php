        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <div class="nav nav-tabs px-3 d-flex flex-lg-row flex-column align-items-start w-100" id="nav-tab"
                ...
                <button class="nav-link" id="nav-booking-tab" data-bs-toggle="tab" data-bs-target="#nav-booking"
                    type="button" role="tab" aria-controls="nav-booking" aria-selected="true">
                    <a href="index.php">
                ...
                <!-- Contact Us Button -->
                <button class="nav-link active-link" id="nav-contact-tab" data-bs-toggle="tab"
    ...
    <section class="container-xxl pb-5" id="contact">
        <div class="container py-5">
            ...
            <div class="text-center mb-4 wow fadeInDown" data-wow-delay="0.1s">
                <h3 class="fw-bold text-dark">Car Trouble🚗? We’re Here 24/7 to Assist You!</h3>
                <h5 class="fw-bold text-muted">Contact Us Anytime – Help is Just a Call Away!</h5>
            </div>
            <div class="row g-5">
                <!-- Contact Information -->
                <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                    <p class="mb-2">Our Location :</p>
                    <h5 class="fw-bold">Egypt, Beni Suef, Car House Center</h5>
                    <hr class="w-100">
                    ...
                    <h5 class="fw-bold">
                        <a href="https://wa.me/201020755784" class="btn btn-success btn-sm mt-2 p-3"><i
                    ...
                    <div class="d-flex pt-2">
                        <a class="btn btn-square submit me-2" href="https://www.facebook.com/isamail.mohamed19"
                            target="_blank">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a class="btn btn-square submit me-2" href="https://www.instagram.com/ismailmohamed194">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="btn btn-square submit me-2" href="https://github.com/ismail-mohamedismail19">
                ...
                <!-- Contact Form -->
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <p class="mb-4">
                        Need roadside assistance or have an inquiry? Fill out the form below, and our team will get back
                        to you promptly.
                    </p>
                    <form action="https://formspree.io/f/mldrrzzw" method="POST">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" id="message" name="message"
                                        placeholder="Leave a message here" style="height: 100px"></textarea>
                                    <label for="message">Message</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn submit py-3 px-5" type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
